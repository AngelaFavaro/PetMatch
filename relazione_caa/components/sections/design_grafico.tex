...
\begin{mdframed}[
    ...
    \textmd{Le principali illustrazioni e il logo PetMatch, sono stati creati senza l'ausilio di strumenti di intelligenza artificiale, utilizzando esclusivamente inventiva personale e software di grafica.}
\end{mdframed}