...
Solo per scopi di valutazione, è stato creato un ulteriore account di test, che consente di testare anche la funzionalità di cambio password e di eliminazione:
\begin{center}
\begin{tabular}{|l|c|c|}
\hline
\rowcolor{brown}
