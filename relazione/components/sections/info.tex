...
Si specifica che agli utenti \texttt{user/user} e \texttt{admin/admin} è stata limitata la funzionalità di modifica password e di eliminazione account. Questo per garantire che tutti possano sempre accedere alle funzionalità del sito senza problemi.\\
