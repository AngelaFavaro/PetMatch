...
\begin{itemize}
    ...
    \item Sono presenti alcuni "salta al contenuto" anche nelle pagine in cui è presente la nav per cambiare pagina (es. in animali se ci sono più di 12 animali appare la possibilità di andare a pagina 2). In questo caso il contenuto di aiuto è display:none se l'url non prevede il parametro \texttt{page}.
    \item Abbiamo inserito delle dialog e con javascript abbiamo limitato l'uscita da esse solo tramite il pulsante apposito di chiusura. In questo modo evitiamo che l'utente possa accidentalmente chiudere la dialog andando avanti col tab.
\end{itemize}
