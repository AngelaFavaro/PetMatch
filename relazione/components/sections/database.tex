...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.35\textwidth]{assets/schema-er.png}}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item Un trasporto è associato ad una richiesta solo se la richiesta è in "In trasporto" e il trasporto 
    \end{itemize}
\end{itemize}