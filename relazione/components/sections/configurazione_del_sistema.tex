...
\begin{itemize}
    ...
    \item caricare nav e breadcrumb specifiche per la pagina (uso di funzioni buildNav, buildNavAdmin, buildBreadcrumb) e rimpiazzarle nei rispettivi placeholder \texttt{\[nav\]} e \texttt{\[breadcrumb\]};
    \item gestire la logica specifica della pagina (es. recupero dati dal database, gestione form, ecc.);
