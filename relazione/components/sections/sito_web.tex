...
\begin{center}
\setcounter{table}{1} 
\begin{tabular}{|p{4.5cm}|p{4.5cm}|p{2cm}|p{2.5cm}|} % Ho allargato leggermente per far spazio ai box
\hline
\rowcolor{brown}
...
Il nome stesso del font rivela la sua nobile origine: è stato infatti progettato dall'agenzia londinese Red Stone per l'associazione britannica \textit{Parkinson’s UK}, con l'intento di creare un linguaggio visivo che fosse al contempo energico, umano e accessibile.\\
...
Inoltre, come descritto nella sezione \ref{sec:layout_responsive}{Layout responsive}, le pagine amministratore, non sono ottimizzate per la visualizzazione su dispositivi mobili, in quanto si presume che gli amministratori accedano al sito principalmente da computer desktop o laptop. In particolare il difetto si riscontra nella nav bar, che non rimane fissa in cima alla pagina come avviene per le pagine utente.
\subsubsection{Logo}
...
\end{adjustwidth}
\subsubsection{Le immagini}
Le illustrazioni tentano di essere inclusive rappresentando persone di diverse etnie, generi di età e anche persone con mobilità ridotta. Le immagini in questione si trovano alle pagine di registrazione e login, lavora con noi, e nel form di adozione degli animali.\\
\begin{adjustwidth}{1cm}{1cm}
