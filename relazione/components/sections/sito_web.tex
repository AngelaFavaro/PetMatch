...
Non sono riportate le combinazioni di colori che non sono state usate come testo e background insieme.
\begin{center}
\begin{tabular}{|p{4.5cm}|p{4.5cm}|p{2cm}|p{3cm}|} % Ho allargato leggermente per far spazio ai box
\hline
\rowcolor{brown}
...
\begin{itemize}
    ...
    \item controllo spaziatura tra lettere (qp, db)
