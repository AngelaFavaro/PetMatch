...
$nav = $isPreferiti ? buildUserNav($userMenu, './preferiti', $_SESSION['email'] ?? false, $_SESSION['admin']===true) : buildUserNav($userMenu, './animali', $_SESSION['email'] ?? false, $_SESSION['admin']===true);
